...
func newSummarizer(c context.Context, chatModel model.BaseChatModel, mmModel model.BaseChatModel, ragTools []tool.BaseTool, bus *tools.ConfirmBus) (*adk.ChatModelAgent, error) {
	// 合并审计工具与知识库工具
